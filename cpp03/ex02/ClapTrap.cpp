...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/02 20:26:23 by lsoulier          #+#    #+#             */
/*   Updated: 2021/02/02 20:26:25 by lsoulier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::_announce() const {
	std::cout << "BEHOLD VAULTHUNTER!!!! A new ClapTrap " << this->_name << " arrives!!" << std::endl;
}
